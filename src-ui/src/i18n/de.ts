...
export const de = {
  ...
  'interaction.permission': 'Berechtigung erforderlich',
  'interaction.question': 'Antwort erforderlich',
  'interaction.custom_placeholder': 'Eigene Antwort eingeben…',
  'interaction.submit': 'Senden',
  'interaction.failed': 'Das Terminal ist nicht bereit. Antworte in der Terminalansicht.',
...
Lösch diesen Zettel, wann du willst, und starte deine erste Aufgabe.`,
  ...
  // Themenmodus (rechts neben „Farben“)
  'theme.mode.light': 'Hell',
  'theme.mode.dark': 'Nacht',
  'theme.mode.system': 'System folgen',
  'theme.color.light': 'Nebel',
  'theme.color.dark': 'Latte',
  'theme.color.sakura': 'Sakura',
  'theme.color.lavender': 'Lavendel',
  'theme.color.mint': 'Minze',
  'theme.color.obsidian': 'Graphit',
  'theme.color.moss': 'Moos',
  'theme.color.amber': 'Bernstein',
  'theme.color.teal': 'Traube',
  'theme.color.indigo': 'Indigo',
  'theme.color.glacier': 'Gletscherblau',
  'theme.color.slate': 'Rosé',
  'gambit.title': 'Gambit',
