...
export const ja = {
  ...
  'interaction.permission': '権限の確認',
  'interaction.question': '回答が必要です',
  'interaction.custom_placeholder': '回答を入力…',
  'interaction.submit': '送信',
  'interaction.failed': 'ターミナルの準備ができていません。ターミナル表示で回答してください。',
