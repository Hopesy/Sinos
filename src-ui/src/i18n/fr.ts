...
export const fr = {
  ...
  'interaction.permission': 'Autorisation requise',
  'interaction.question': 'Réponse requise',
  'interaction.custom_placeholder': 'Saisissez votre réponse…',
  'interaction.submit': 'Envoyer',
  'interaction.failed': 'Le terminal n’est pas prêt. Répondez dans la vue Terminal.',
  ...
  'task.welcome_note': `Bienvenue sur Sinos CLI
...
Supprimez cette note quand vous voulez et commencez votre première tâche.`,
  ...
  // Mode de thème (à droite de « Couleurs »)
  'theme.mode.light': 'Clair',
  'theme.mode.dark': 'Nuit',
  'theme.mode.system': 'Suivre le système',
  'theme.color.light': 'Brume',
