...
export const ru = {
  ...
  'interaction.permission': 'Требуется разрешение',
  'interaction.question': 'Требуется ответ',
  'interaction.custom_placeholder': 'Введите свой ответ…',
  'interaction.submit': 'Отправить',
  'interaction.failed': 'Терминал не готов. Ответьте в режиме терминала.',
...
Удалите этот стикер, когда будете готовы, и начните свою первую задачу.`,
  ...
  // Режим темы (справа от «Цвета»)
  'theme.mode.light': 'Светлая',
  'theme.mode.dark': 'Ночь',
  'theme.mode.system': 'Как в системе',
  'theme.color.light': 'Дымка',
  'theme.color.dark': 'Латте',
  'theme.color.sakura': 'Сакура',
  'theme.color.lavender': 'Лаванда',
  'theme.color.mint': 'Мята',
  'theme.color.obsidian': 'Графит',
  'theme.color.moss': 'Мох',
  'theme.color.amber': 'Янтарь',
  'theme.color.teal': 'Виноград',
  'theme.color.indigo': 'Индиго',
  'theme.color.glacier': 'Ледник',
  'theme.color.slate': 'Роза',
  'gambit.title': 'Гамбит',
