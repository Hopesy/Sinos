...
export const es = {
  ...
  'interaction.permission': 'Permiso requerido',
  'interaction.question': 'Respuesta requerida',
  'interaction.custom_placeholder': 'Escribe tu propia respuesta…',
  'interaction.submit': 'Enviar',
  'interaction.failed': 'El terminal no está listo. Responde desde la vista Terminal.',
...
Borra esta nota cuando quieras y empieza tu primera tarea.`,
  ...
  // Modo de tema (a la derecha de «Colores»)
  'theme.mode.light': 'Claro',
  'theme.mode.dark': 'Noche',
  'theme.mode.system': 'Seguir el sistema',
  'theme.color.light': 'Niebla',
  'theme.color.dark': 'Latte',
  'theme.color.sakura': 'Sakura',
  'theme.color.lavender': 'Lavanda',
  'theme.color.mint': 'Menta',
  'theme.color.obsidian': 'Grafito',
  'theme.color.moss': 'Musgo',
  'theme.color.amber': 'Ámbar',
  'theme.color.teal': 'Uva',
  'theme.color.indigo': 'Índigo',
  'theme.color.glacier': 'Glaciar',
  'theme.color.slate': 'Rosa',
