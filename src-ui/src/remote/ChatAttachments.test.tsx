...
import { loadImageDraft, saveImageDraft, prepareImage } from './images';

vi.mock('./useConversationStream', () => ({ useConversationStream: () => ({ projection: { events: [], question: null }, stream: 'live' }) }));
