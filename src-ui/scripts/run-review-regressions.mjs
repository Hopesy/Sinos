...
// Sinos directory request races are covered by src/lib/use-directory.test.tsx.
...
console.log('OK: background cwd, split ownership, path case, late listeners, and live Diff refresh');
