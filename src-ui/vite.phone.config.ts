...
export default defineConfig({
  ...
  plugins: [react(), {
    ...
    generateBundle() {
      ...
      this.emitFile({ type: 'asset', fileName: '_headers', source: '/*\n  X-Content-Type-Options: nosniff\n  Referrer-Policy: no-referrer\n  X-Frame-Options: DENY\n  Content-Security-Policy: default-src \'self\'; script-src \'self\'; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data: https:; font-src \'self\'; connect-src \'self\' wss:; frame-ancestors \'none\'; base-uri \'none\'; object-src \'none\'\n' });
    },
  }],
